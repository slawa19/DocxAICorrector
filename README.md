...
- `DOCX_AI_MODELS_STRUCTURE_RECOGNITION_DEFAULT` — optional override для structure-recognition role. Если не задан, stage использует `DOCX_AI_MODELS_TEXT_DEFAULT`.
