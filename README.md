...
Latest manifest теперь также фиксирует `document_profile_id`, `run_profile_id`, `validation_tier` и явные runtime override-ы относительно UI defaults.
...
Подробности workflow и структуры артефактов: `docs/REAL_DOCUMENT_VALIDATION_WORKFLOW.md`.
