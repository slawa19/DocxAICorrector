---
description: Convert the active feature's tasks into dependency-ordered GitHub issues (Spec Kit).
---

Read `.agents/skills/speckit-taskstoissues/SKILL.md` and follow it exactly. This command is a thin wrapper: the skill file is the single source of truth. Do not improvise a different workflow.
