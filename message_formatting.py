...
_REASON_PREFIXES: list[tuple[str, str]] = [
    ...
    ("compare_all_safe_variant_prepared", "подготовлен safe-вариант для compare-all"),
]
...
def get_preparation_state_unavailable_message() -> str:
    return (
        "Состояние подготовки файла недоступно. Если документ не появился в режиме готовности, "
